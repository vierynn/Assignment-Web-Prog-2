            ...
            <div class="col-md-8">
              <div class="card-body p-4">
                ...
                <div class="logo-container">
                    <a href="\aurellia" class='logo-ig'><button type="button" class="btn btn-outline-secondary">Scores</button></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row g-0">
            ...
            <div class="col-md-8">
              <div class="card-body p-4">
                ...
                <hr class="mt-0 mb-4">
                <div class="logo-container">
                    <a href="\amanda" class='logo-ig'><button type="button" class="btn btn-outline-secondary">Scores</button></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row g-0">
            ...
            <div class="col-md-8">
              <div class="card-body p-4">
                ...
                <hr class="mt-0 mb-4">
                <div class="logo-container">
                    <a href="\virgie" class='logo-ig'><button type="button" class="btn btn-outline-secondary">Scores</button></a>
                </div>
              </div>
            </div>
          </div>
